...
const BLOG = {
  AUTHOR: 'junhuame', // 作者
  BIO: '一个学习者', // 作者简介
  LINK: 'http://blog.junh.wang', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '6baa44219a3d4560b9dd9abc98778777', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '滇ICP备18003359号', // 备案号 滇ICP备XXXXXXX
  ...
  CONTACT_EMAIL: 'mail@junh.wang',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/junhuame',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'waline.junh.wang', // Waline 评论 @see https://waline.js.org/guide/get-started.html
